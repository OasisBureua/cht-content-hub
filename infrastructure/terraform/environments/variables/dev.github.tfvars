...
# Overridden per deploy by workflow (-var api_image / worker_image)
api_image    = "233636046512.dkr.ecr.us-east-1.amazonaws.com/contenthub-api:1.0.0"
worker_image = "233636046512.dkr.ecr.us-east-1.amazonaws.com/contenthub-worker:1.0.0"
...
# Optional — set when CHT cache-clear endpoint is live:
# cht_cache_clear_url = "https://devapp.communityhealth.media/api/internal/cache/clear"
